...
function About() {
  ...
  return (
    <div className="About-page">
      ...
      <p className="section-subtitle fa[deInDown">Designed to help patients track their progress and share their experiences with their psychologists during Cognitive Behavioural Therapy (CBT).</p>
